...
_lr_productions = [
  ...
  ('programa -> PROGRAM ID SEMICOLON declaracion_global funcion main bloque','programa',7,'p_programa','Parser.py',17),
  ('main -> MAIN O_PARENTHESIS C_PARENTHESIS','main',3,'p_main','Parser.py',32),
  ('bloque -> O_CBRACKET bloque_prime C_CBRACKET','bloque',3,'p_bloque','Parser.py',45),
  ('bloque_prime -> estatuto bloque_prime','bloque_prime',2,'p_bloque_prime','Parser.py',51),
  ('bloque_prime -> epsilon','bloque_prime',1,'p_bloque_prime','Parser.py',52),
  ('declaracion_funcion -> declaracion','declaracion_funcion',1,'p_declaracion_funcion','Parser.py',59),
  ('declaracion_funcion -> epsilon','declaracion_funcion',1,'p_declaracion_funcion','Parser.py',60),
  ('declaracion_global -> declaracion','declaracion_global',1,'p_declaracion_global','Parser.py',69),
  ('declaracion -> declaracion_base','declaracion',1,'p_declaracion','Parser.py',77),
  ('declaracion -> declaracion_base declaracion','declaracion',2,'p_declaracion','Parser.py',78),
  ('declaracion_base -> LET declaracion_prime COLON declaracion_tipo SEMICOLON','declaracion_base',5,'p_declaracion_base','Parser.py',84),
  ('declaracion_prime -> declaracion_variable','declaracion_prime',1,'p_declaracion_prime','Parser.py',90),
  ('declaracion_prime -> declaracion_variable COMMA declaracion_prime','declaracion_prime',3,'p_declaracion_prime','Parser.py',91),
  ('declaracion_variable -> ID O_ABRACKET CTE_INT C_ABRACKET O_ABRACKET CTE_INT C_ABRACKET O_ABRACKET CTE_INT C_ABRACKET','declaracion_variable',10,'p_declaracion_variable','Parser.py',98),
  ('declaracion_variable -> ID O_ABRACKET CTE_INT C_ABRACKET O_ABRACKET CTE_INT C_ABRACKET','declaracion_variable',7,'p_declaracion_variable','Parser.py',99),
  ('declaracion_variable -> ID O_ABRACKET CTE_INT C_ABRACKET','declaracion_variable',4,'p_declaracion_variable','Parser.py',100),
  ('declaracion_variable -> ID','declaracion_variable',1,'p_declaracion_variable','Parser.py',101),
  ('declaracion_tipo -> INT','declaracion_tipo',1,'p_declaracion_tipo','Parser.py',121),
  ('declaracion_tipo -> FLOAT','declaracion_tipo',1,'p_declaracion_tipo','Parser.py',122),
  ('declaracion_tipo -> CHAR','declaracion_tipo',1,'p_declaracion_tipo','Parser.py',123),
  ('declaracion_tipo -> STRING','declaracion_tipo',1,'p_declaracion_tipo','Parser.py',124),
  ('param_tipo -> INT ID','param_tipo',2,'p_param_tipo','Parser.py',138),
  ('param_tipo -> FLOAT ID','param_tipo',2,'p_param_tipo','Parser.py',139),
  ('param_tipo -> CHAR ID','param_tipo',2,'p_param_tipo','Parser.py',140),
  ('param_tipo -> STRING ID','param_tipo',2,'p_param_tipo','Parser.py',141),
  ('funcion -> funcion_base funcion','funcion',2,'p_funcion','Parser.py',158),
  ('funcion -> epsilon','funcion',1,'p_funcion','Parser.py',159),
  ('funcion_base -> FUNCTION funcion_ident O_PARENTHESIS funcion_prime C_PARENTHESIS declaracion_funcion bloque','funcion_base',7,'p_funcion_base','Parser.py',165),
  ('funcion_prime -> param_tipo','funcion_prime',1,'p_funcion_prime','Parser.py',177),
  ('funcion_prime -> param_tipo COMMA funcion_prime','funcion_prime',3,'p_funcion_prime','Parser.py',178),
  ('funcion_ident -> VOID ID','funcion_ident',2,'p_funcion_ident','Parser.py',185),
  ('funcion_ident -> INT ID','funcion_ident',2,'p_funcion_ident','Parser.py',186),
  ('funcion_ident -> FLOAT ID','funcion_ident',2,'p_funcion_ident','Parser.py',187),
  ('funcion_ident -> CHAR ID','funcion_ident',2,'p_funcion_ident','Parser.py',188),
  ('funcion_ident -> STRING ID','funcion_ident',2,'p_funcion_ident','Parser.py',189),
  ('variable -> var_array','variable',1,'p_variable','Parser.py',219),
  ('variable -> ID','variable',1,'p_variable','Parser.py',220),
  ('var_array -> arr_id O_ABRACKET exp arr_close_bracket arr_open_bracket exp arr_close_bracket arr_open_bracket exp arr_close_bracket','var_array',10,'p_var_array','Parser.py',240),
  ('var_array -> arr_id O_ABRACKET exp arr_close_bracket arr_open_bracket exp arr_close_bracket','var_array',7,'p_var_array','Parser.py',241),
  ('var_array -> arr_id O_ABRACKET exp arr_close_bracket','var_array',4,'p_var_array','Parser.py',242),
  ('arr_id -> ID','arr_id',1,'p_arr_id','Parser.py',266),
  ('arr_close_bracket -> C_ABRACKET','arr_close_bracket',1,'p_arr_close_bracket','Parser.py',285),
  ('arr_open_bracket -> O_ABRACKET','arr_open_bracket',1,'p_arr_open_bracket','Parser.py',333),
  ('estatuto -> asignacion SEMICOLON','estatuto',2,'p_estatuto','Parser.py',343),
  ('estatuto -> llamada SEMICOLON','estatuto',2,'p_estatuto','Parser.py',344),
  ('estatuto -> retorno SEMICOLON','estatuto',2,'p_estatuto','Parser.py',345),
  ('estatuto -> lectura SEMICOLON','estatuto',2,'p_estatuto','Parser.py',346),
  ('estatuto -> escritura SEMICOLON','estatuto',2,'p_estatuto','Parser.py',347),
  ('estatuto -> decision','estatuto',1,'p_estatuto','Parser.py',348),
  ('estatuto -> while','estatuto',1,'p_estatuto','Parser.py',349),
  ('estatuto -> for','estatuto',1,'p_estatuto','Parser.py',350),
  ('asignacion -> variable ASSIGN asignacion_expr','asignacion',3,'p_asignacion','Parser.py',357),
  ('asignacion_expr -> expr','asignacion_expr',1,'p_asignacion_expr','Parser.py',363),
  ('llamada -> function_id O_PARENTHESIS llamada_prime C_PARENTHESIS','llamada',4,'p_llamada','Parser.py',380),
  ('function_id -> ID','function_id',1,'p_function_id','Parser.py',394),
  ('llamada_prime -> llamada_exp','llamada_prime',1,'p_llamada_prime','Parser.py',412),
  ('llamada_prime -> llamada_exp llamada_comma llamada_prime','llamada_prime',3,'p_llamada_prime','Parser.py',413),
  ('llamada_exp -> exp','llamada_exp',1,'p_llamada_exp','Parser.py',423),
  ('llamada_comma -> COMMA','llamada_comma',1,'p_llamada_comma','Parser.py',447),
  ('retorno -> RETURN expr','retorno',2,'p_retorno','Parser.py',456),
  ('lectura -> READ O_PARENTHESIS lectura_prime C_PARENTHESIS','lectura',4,'p_lectura','Parser.py',483),
  ('lectura_prime -> variable','lectura_prime',1,'p_lectura_prime','Parser.py',489),
  ('lectura_prime -> variable COMMA lectura_prime','lectura_prime',3,'p_lectura_prime','Parser.py',490),
  ('escritura -> WRITE O_PARENTHESIS escritura_prime C_PARENTHESIS','escritura',4,'p_escritura','Parser.py',502),
  ('escritura_prime -> expr','escritura_prime',1,'p_escritura_prime','Parser.py',508),
  ('escritura_prime -> escritura_string','escritura_prime',1,'p_escritura_prime','Parser.py',509),
  ('escritura_prime -> expr COMMA escritura_prime','escritura_prime',3,'p_escritura_prime','Parser.py',510),
  ('escritura_prime -> escritura_string COMMA escritura_prime','escritura_prime',3,'p_escritura_prime','Parser.py',511),
  ('escritura_string -> CTE_STRING','escritura_string',1,'p_escritura_string','Parser.py',522),
  ('decision -> IF O_PARENTHESIS decision_expr C_PARENTHESIS bloque else','decision',6,'p_decision','Parser.py',535),
  ('decision_expr -> expr','decision_expr',1,'p_decision_expr','Parser.py',541),
  ('else -> else_prime bloque','else',2,'p_else','Parser.py',559),
  ('else -> epsilon','else',1,'p_else','Parser.py',560),
  ('else_prime -> ELSE','else_prime',1,'p_else_prime','Parser.py',567),
  ('while -> while_prime while_expr bloque','while',3,'p_while','Parser.py',582),
  ('while_prime -> WHILE','while_prime',1,'p_while_prime','Parser.py',596),
  ('while_expr -> O_PARENTHESIS expr C_PARENTHESIS','while_expr',3,'p_while_expr','Parser.py',603),
  ('for -> FOR for_asignacion for_to for_exp bloque','for',5,'p_for','Parser.py',621),
  ('for_asignacion -> variable ASSIGN for_asignacion_expr','for_asignacion',3,'p_for_asignacion','Parser.py',647),
  ('for_asignacion_expr -> expr','for_asignacion_expr',1,'p_for_asignacion_expr','Parser.py',653),
  ('for_to -> TO','for_to',1,'p_for_to','Parser.py',673),
  ('for_exp -> exp','for_exp',1,'p_for_exp','Parser.py',680),
  ('expr -> or','expr',1,'p_expr','Parser.py',713),
  ('or -> and','or',1,'p_or','Parser.py',720),
  ('or -> and or_operador or','or',3,'p_or','Parser.py',721),
  ('or_operador -> OR','or_operador',1,'p_or_operador','Parser.py',755),
  ('and -> equal','and',1,'p_and','Parser.py',763),
  ('and -> equal and_operador and','and',3,'p_and','Parser.py',764),
  ('and_operador -> AND','and_operador',1,'p_and_operador','Parser.py',798),
  ('equal -> compare','equal',1,'p_equal','Parser.py',806),
  ('equal -> compare equal_operador compare','equal',3,'p_equal','Parser.py',807),
  ('equal_operador -> EQUAL','equal_operador',1,'p_equal_operador','Parser.py',841),
  ('equal_operador -> NOT_EQUAL','equal_operador',1,'p_equal_operador','Parser.py',842),
  ('compare -> exp','compare',1,'p_compare','Parser.py',850),
  ('compare -> exp compare_operador exp','compare',3,'p_compare','Parser.py',851),
  ('compare_operador -> GREATER','compare_operador',1,'p_compare_operador','Parser.py',885),
  ('compare_operador -> LESSER','compare_operador',1,'p_compare_operador','Parser.py',886),
  ('compare_operador -> GREATER_EQUAL','compare_operador',1,'p_compare_operador','Parser.py',887),
  ('compare_operador -> LESSER_EQUAL','compare_operador',1,'p_compare_operador','Parser.py',888),
  ('exp -> termino','exp',1,'p_exp','Parser.py',896),
  ('exp -> termino exp_operador exp','exp',3,'p_exp','Parser.py',897),
  ('exp_operador -> PLUS','exp_operador',1,'p_exp_operador','Parser.py',934),
  ('exp_operador -> MINUS','exp_operador',1,'p_exp_operador','Parser.py',935),
  ('termino -> factor','termino',1,'p_termino','Parser.py',943),
  ('termino -> factor termino_operador termino','termino',3,'p_termino','Parser.py',944),
  ('termino_operador -> TIMES','termino_operador',1,'p_termino_operador','Parser.py',979),
  ('termino_operador -> DIVIDE','termino_operador',1,'p_termino_operador','Parser.py',980),
  ('termino_operador -> MODULE','termino_operador',1,'p_termino_operador','Parser.py',981),
  ('factor -> variable','factor',1,'p_factor','Parser.py',989),
  ('factor -> O_PARENTHESIS expr C_PARENTHESIS','factor',3,'p_factor','Parser.py',990),
  ('factor -> llamada retorno_llamada','factor',2,'p_factor','Parser.py',991),
  ('factor -> cte','factor',1,'p_factor','Parser.py',992),
  ('factor -> PLUS cte','factor',2,'p_factor','Parser.py',993),
  ('factor -> MINUS cte','factor',2,'p_factor','Parser.py',994),
  ('retorno_llamada -> epsilon','retorno_llamada',1,'p_retorno_llamada','Parser.py',1001),
  ('cte -> CTE_INT','cte',1,'p_cte','Parser.py',1011),
  ('cte -> CTE_FLOAT','cte',1,'p_cte','Parser.py',1012),
  ('epsilon -> <empty>','epsilon',0,'p_epsilon','Parser.py',1031),
]
